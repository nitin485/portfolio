  ...
  return (
    <section className="bg-black py-28 border-b border-gray-900">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="blockw-fit md:flex items-end justify-between mb-20">
          <div>
          ...
          <div className=" block md:flex items-center gap-3 pb-3 mt-10  ">
        ...
        {/* ── Skill cards ── */}
        <div className="grid  grid-cols-2  space-y-4 md:grid-cols-5 gap-4">
